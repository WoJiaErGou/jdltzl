...
class Jdltspider(scrapy.Spider):
    ...
    start_urls=['https://www.jdbbs.com/search.php?mod=forum&searchid=1097&orderby=lastpost&ascdesc=desc&searchsubmit=yes&kw=%B8%F1%C1%A6',
                'https://www.jdbbs.com/search.php?mod=forum&searchid=370&orderby=lastpost&ascdesc=desc&searchsubmit=yes&page=2'
        ]
    ...
    def parse(self, response):
        ...
        for each in response.xpath(".//div[@class='tl']/div[@id='threadlist']/ul/li/h3/a"):
            ...
            # href='https://www.jdbbs.com/thread-8331873-1-1.html'
            #请求具体网页
            item=JdltspiItem()
